                                ...
                                <tbody>
                                    ...
                                    <c:forEach var="cartDetail" items="${cartDetail}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4">
                                                    <a href="/product/${cartDetail.value.id}" target="_blank">
                                                        ${cartDetail.value.name}
                                                    </a>
                                                </p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="input-group quantity mt-4" style="width: 100px;">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        data-cart-detail-id="${cartDetail.key.id}"
                                                        data-cart-detail-price="${cartDetail.key.price}">
                                                    <div class="input-group-btn">
                                                        <button
                                            ...
                                            <td>
                                                <p class="mb-0 mt-4" data-cart-detail-id="${cartDetail.key.id}">
                                                    <fmt:formatNumber type="number"
                                                        value="${cartDetail.key.price * cartDetail.key.quantity}" /> đ
                                                </p>
                                            </td>
                                            <td>
                                                <form method="post" action="/delete-cart-product/${cartDetail.key.id}">
